...
var canvasBase = {
	...
	updateBase: func() {
		...
		# FF
		me["FF1"].setText(sprintf("%d", math.round(systems.ENGINE.ffActual[0].getValue(), 10)));
		me["FF2"].setText(sprintf("%d", math.round(systems.ENGINE.ffActual[1].getValue(), 10)));
		me["FF3"].setText(sprintf("%d", math.round(systems.ENGINE.ffActual[2].getValue(), 10)));
	...
	updateBaseDials: func() {
		...
		if (Value.Fadec.powered[0]) {
			me["EGT1"].setText(sprintf("%d", systems.ENGINE.egtActual[0].getValue()));
		...
		if (Value.Fadec.powered[1]) {
			me["EGT2"].setText(sprintf("%d", systems.ENGINE.egtActual[1].getValue()));
		...
		if (Value.Fadec.powered[2]) {
			me["EGT3"].setText(sprintf("%d", systems.ENGINE.egtActual[2].getValue()));
		...
		# N2
		if (Value.Fadec.powered[0]) {
			Value.Fadec.n2[0] = systems.ENGINE.n2Actual[0].getValue();
		...
		if (Value.Fadec.powered[1]) {
			Value.Fadec.n2[1] = systems.ENGINE.n2Actual[1].getValue();
		...
		if (Value.Fadec.powered[2]) {
			Value.Fadec.n2[2] = systems.ENGINE.n2Actual[2].getValue();
	...
	updateBaseTapes: func() {
		...
		# EGT
		if (Value.Fadec.powered[0]) {
			Value.Fadec.egt[0] = systems.ENGINE.egtActual[0].getValue();
		...
		if (Value.Fadec.powered[1]) {
			Value.Fadec.egt[1] = systems.ENGINE.egtActual[1].getValue();
		...
		if (Value.Fadec.powered[2]) {
			Value.Fadec.egt[2] = systems.ENGINE.egtActual[2].getValue();
...
var canvasGeDials = {
	...
	update: func() {
		...
		# N1
		if (Value.Fadec.powered[0]) {
			Value.Fadec.n1[0] = systems.ENGINE.n1Actual[0].getValue();
		...
		if (Value.Fadec.powered[1]) {
			Value.Fadec.n1[1] = systems.ENGINE.n1Actual[1].getValue();
		...
		if (Value.Fadec.powered[2]) {
			Value.Fadec.n1[2] = systems.ENGINE.n1Actual[2].getValue();
...
var canvasPwDials = {
	...
	update: func() {
		...
		# EPR
		if (Value.Fadec.powered[0]) {
			Value.Fadec.epr[0] = systems.ENGINE.eprActual[0].getValue();
		...
		if (Value.Fadec.powered[1]) {
			Value.Fadec.epr[1] = systems.ENGINE.eprActual[1].getValue();
		...
		if (Value.Fadec.powered[2]) {
			Value.Fadec.epr[2] = systems.ENGINE.eprActual[2].getValue();
...
var canvasPwTapes = {
	...
	update: func() {
		...
		if (Value.Fadec.powered[0]) {
			Value.Fadec.epr[0] = systems.ENGINE.eprActual[0].getValue();
			Value.Fadec.eprFixed[0] = systems.ENGINE.eprActual[0].getValue() + 0.005;
		...
		if (Value.Fadec.powered[1]) {
			Value.Fadec.epr[1] = systems.ENGINE.eprActual[1].getValue();
			Value.Fadec.eprFixed[1] = systems.ENGINE.eprActual[1].getValue() + 0.005;
		...
		if (Value.Fadec.powered[2]) {
			Value.Fadec.epr[2] = systems.ENGINE.eprActual[2].getValue();
			Value.Fadec.eprFixed[2] = systems.ENGINE.eprActual[2].getValue() + 0.005;
