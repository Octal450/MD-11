...
var CanvasGeDials = {
	...
	update: func() {
		...
		if (Value.Fadec.powered[0]) {
			...
			me["N11_hundreds"].setTranslation(0, genevaN1Hundreds(num(right(sprintf("%06.2f", Value.Fadec.n1Round[0]), 6))) * 34);
			me["N11_tens"].setTranslation(0, genevaN1Tens(num(right(sprintf("%05.2f", Value.Fadec.n1Round[0]), 5))) * 34);
			me["N11_ones"].setTranslation(0, genevaN1Ones(num(right(sprintf("%04.2f", Value.Fadec.n1Round[0]), 4))) * 34);
		...
		if (Value.Fadec.powered[1]) {
			...
			me["N12_hundreds"].setTranslation(0, genevaN1Hundreds(num(right(sprintf("%06.2f", Value.Fadec.n1Round[1]), 6))) * 34);
			me["N12_tens"].setTranslation(0, genevaN1Tens(num(right(sprintf("%05.2f", Value.Fadec.n1Round[1]), 5))) * 34);
			me["N12_ones"].setTranslation(0, genevaN1Ones(num(right(sprintf("%04.2f", Value.Fadec.n1Round[1]), 4))) * 34);
		...
		if (Value.Fadec.powered[2]) {
			...
			me["N13_hundreds"].setTranslation(0, genevaN1Hundreds(num(right(sprintf("%06.2f", Value.Fadec.n1Round[2]), 6))) * 34);
			me["N13_tens"].setTranslation(0, genevaN1Tens(num(right(sprintf("%05.2f", Value.Fadec.n1Round[2]), 5))) * 34);
			me["N13_ones"].setTranslation(0, genevaN1Ones(num(right(sprintf("%04.2f", Value.Fadec.n1Round[2]), 4))) * 34);
...
var CanvasPwDials = {
	...
	setDials: func() {
		if (pts.Systems.Acconfig.Options.n1BelowEpr.getBoolValue()) {
			me["EGT_group"].setTranslation(0, 152);
			me["N1_group"].setTranslation(0, -152);
		} else {
	...
	update: func() {
		...
		me["EPR1_lim"].setRotation(math.clamp((-45 + (Value.Fadec.eprLimit / 2.16 * 180)), -45, 135) * D2R);
		me["EPR2_lim"].setRotation(math.clamp((-45 + (Value.Fadec.eprLimit / 2.16 * 180)), -45, 135) * D2R);
		me["EPR3_lim"].setRotation(math.clamp((-45 + (Value.Fadec.eprLimit / 2.16 * 180)), -45, 135) * D2R);
		
		# EPR
		if (Value.Fadec.powered[0]) {
			Value.Fadec.epr[0] = systems.ENGINES.epr[0].getValue();
			Value.Fadec.eprRound[0] = math.round(Value.Fadec.epr[0], 0.001);
			
			me["EPR1_ones"].setTranslation(0, genevaEprOnes(num(right(sprintf("%05.2f", Value.Fadec.eprRound[0] * 10), 5))) * 34);
			me["EPR1_tenths"].setTranslation(0, genevaEprTenths(num(right(sprintf("%04.2f", Value.Fadec.eprRound[0] * 10), 4))) * 34);
			...
			if (!systems.FADEC.n1Mode[0].getValue()) {
				me["EPR1_thr"].setRotation(math.clamp((-45 + (systems.FADEC.targetEpr[0].getValue() / 2.16 * 180)), -45, 135) * D2R);
				me["EPR1_thr"].show();
			} else {
				me["EPR1_thr"].hide();
			}
		...
		if (Value.Fadec.powered[1]) {
			...
			Value.Fadec.eprRound[1] = math.round(Value.Fadec.epr[1], 0.001);
			
			me["EPR2_ones"].setTranslation(0, genevaEprOnes(num(right(sprintf("%05.2f", Value.Fadec.eprRound[1] * 10), 5))) * 34);
			me["EPR2_tenths"].setTranslation(0, genevaEprTenths(num(right(sprintf("%04.2f", Value.Fadec.eprRound[1] * 10), 4))) * 34);
			...
			if (!systems.FADEC.n1Mode[1].getValue()) {
				me["EPR2_thr"].setRotation(math.clamp((-45 + (systems.FADEC.targetEpr[1].getValue() / 2.16 * 180)), -45, 135) * D2R);
				me["EPR2_thr"].show();
			} else {
				me["EPR2_thr"].hide();
			}
		...
		if (Value.Fadec.powered[2]) {
			...
			Value.Fadec.eprRound[2] = math.round(Value.Fadec.epr[2], 0.001);
			
			me["EPR3_ones"].setTranslation(0, genevaEprOnes(num(right(sprintf("%05.2f", Value.Fadec.eprRound[2] * 10), 5))) * 34);
			me["EPR3_tenths"].setTranslation(0, genevaEprTenths(num(right(sprintf("%04.2f", Value.Fadec.eprRound[2] * 10), 4))) * 34);
			...
			if (!systems.FADEC.n1Mode[2].getValue()) {
				me["EPR3_thr"].setRotation(math.clamp((-45 + (systems.FADEC.targetEpr[2].getValue() / 2.16 * 180)), -45, 135) * D2R);
				me["EPR3_thr"].show();
			} else {
				me["EPR3_thr"].hide();
			}
...
var CanvasPwTapes = {
	...
	update: func() {
		...
		me["EPR1_lim"].setTranslation(0, math.clamp((Value.Fadec.eprLimit - 0.4) / 1.6 * -293, -293, 0));
		me["EPR2_lim"].setTranslation(0, math.clamp((Value.Fadec.eprLimit - 0.4) / 1.6 * -293, -293, 0));
		me["EPR3_lim"].setTranslation(0, math.clamp((Value.Fadec.eprLimit - 0.4) / 1.6 * -293, -293, 0));
		...
		if (Value.Fadec.powered[0]) {
			...
			me["EPR1_bar"].setTranslation(0, math.clamp((Value.Fadec.epr[0] - 0.4) / 1.6 * -293, -293, 0));
			if (!systems.FADEC.n1Mode[0].getValue()) {
				me["EPR1_thr"].setTranslation(0, math.clamp((systems.FADEC.targetEpr[0].getValue() - 0.4) / 1.6 * -293, -293, 0));
				me["EPR1_thr"].show();
			} else {
				me["EPR1_thr"].hide();
			}
		...
		if (Value.Fadec.powered[1]) {
			...
			me["EPR2_bar"].setTranslation(0, math.clamp((Value.Fadec.epr[1] - 0.4) / 1.6 * -293, -293, 0));
			if (!systems.FADEC.n1Mode[1].getValue()) {
				me["EPR2_thr"].setTranslation(0, math.clamp((systems.FADEC.targetEpr[1].getValue() - 0.4) / 1.6 * -293, -293, 0));
				me["EPR2_thr"].show();
			} else {
				me["EPR2_thr"].hide();
			}
		...
		if (Value.Fadec.powered[2]) {
			...
			me["EPR3_bar"].setTranslation(0, math.clamp((Value.Fadec.epr[2] - 0.4) / 1.6 * -293, -293, 0));
			if (!systems.FADEC.n1Mode[2].getValue()) {
				me["EPR3_thr"].setTranslation(0, math.clamp((systems.FADEC.targetEpr[2].getValue() - 0.4) / 1.6 * -293, -293, 0));
				me["EPR3_thr"].show();
			} else {
				me["EPR3_thr"].hide();
			}
