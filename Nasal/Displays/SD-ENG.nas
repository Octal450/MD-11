...
var CanvasEngDials = {
	...
	update: func() {
		...
		me["OilPsi1_needle"].setRotation((-45 + (Value.Eng.oilPsi[0] / Value.Eng.oilPsiScale * 180)) * D2R);
		
		me["OilPsi2"].setText(sprintf("%d", Value.Eng.oilPsi[1]));
		me["OilPsi2_needle"].setRotation((-45 + (Value.Eng.oilPsi[1] / Value.Eng.oilPsiScale * 180)) * D2R);
		
		me["OilPsi3"].setText(sprintf("%d", Value.Eng.oilPsi[2]));
		me["OilPsi3_needle"].setRotation((-45 + (Value.Eng.oilPsi[2] / Value.Eng.oilPsiScale * 180)) * D2R);
		
		# Oil Temp
		if (Value.Eng.fadecPowered[0]) {
			Value.Eng.oilTemp[0] = systems.ENGINES.oilTemp[0].getValue();
			...
			if (Value.Eng.type == "PW") {
				if (Value.Eng.oilTemp[0] < 49.5) {
					...
					me["OilTemp1_needle"].setColor(0.9412, 0.7255, 0);
				} else {
		...
		if (Value.Eng.fadecPowered[1]) {
			Value.Eng.oilTemp[1] = systems.ENGINES.oilTemp[1].getValue();
			...
			if (Value.Eng.type == "PW") {
				if (Value.Eng.oilTemp[1] < 49.5) {
					...
					me["OilTemp2_needle"].setColor(0.9412, 0.7255, 0);
				} else {
		...
		if (Value.Eng.fadecPowered[2]) {
			Value.Eng.oilTemp[2] = systems.ENGINES.oilTemp[2].getValue();
			...
			if (Value.Eng.type == "PW") {
				if (Value.Eng.oilTemp[2] < 49.5) {
					...
					me["OilTemp3_needle"].setColor(0.9412, 0.7255, 0);
				} else {
		...
		if (Value.Eng.oilQty[0] < 4.5) {
			...
			me["OilQty1_box"].show();
			me["OilQty1_needle"].setColor(0.9412, 0.7255, 0);
		} else {
		...
		if (Value.Eng.oilQty[1] < 4.5) {
			me["OilQty2"].setColor(0.9412, 0.7255, 0);
			me["OilQty2_box"].show();
			me["OilQty2_needle"].setColor(0.9412, 0.7255, 0);
		} else {
		...
		if (Value.Eng.oilQty[2] < 4.5) {
			me["OilQty3"].setColor(0.9412, 0.7255, 0);
			me["OilQty3_box"].show();
			me["OilQty3_needle"].setColor(0.9412, 0.7255, 0);
		} else {
...
var CanvasEngTapes = {
	...
	update: func() {
		...
		if (Value.Eng.oilQtyCline[0] != -1) {
			me["OilQty1_cline"].setTranslation(0, Value.Eng.oilQtyCline[0] / 30 * -251);
			me["OilQty1_cline"].show();
		} else {
			me["OilQty1_cline"].hide();
		}
		if (Value.Eng.oilQtyCline[1] != -1) {
			me["OilQty2_cline"].setTranslation(0, Value.Eng.oilQtyCline[1] / 30 * -251);
			me["OilQty2_cline"].show();
		} else {
			me["OilQty2_cline"].hide();
		}
		if (Value.Eng.oilQtyCline[2] != -1) {
			me["OilQty3_cline"].setTranslation(0, Value.Eng.oilQtyCline[2] / 30 * -251);
			me["OilQty3_cline"].show();
		} else {
			me["OilQty3_cline"].hide();
		}
