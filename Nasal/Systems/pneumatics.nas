...
var PNEUMATICS = {
	...
	Hvac: {
		...
		pack1Temp: props.globals.getNode("/systems/pneumatics/hvac/pack-temp/pack-1"),
		pack2Temp: props.globals.getNode("/systems/pneumatics/hvac/pack-temp/pack-2"),
		pack3Temp: props.globals.getNode("/systems/pneumatics/hvac/pack-temp/pack-3"),
	},
	PackCmd: {
