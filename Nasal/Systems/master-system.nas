...
var FCTL = {
	...
	Switch: {
		elevatorFeelKnob: props.globals.getNode("/controls/fctl/switches/elevator-feel-knob"),
		elevatorFeelMan: props.globals.getNode("/controls/fctl/switches/elevator-feel-man"),
		flapLimit: props.globals.getNode("/controls/fctl/switches/flap-limit-knob"),
		lsasLeftIn: props.globals.getNode("/controls/fctl/switches/lsas-left-in"),
		lsasLeftOut: props.globals.getNode("/controls/fctl/switches/lsas-left-out"),
		lsasRightIn: props.globals.getNode("/controls/fctl/switches/lsas-right-in"),
		lsasRightOut: props.globals.getNode("/controls/fctl/switches/lsas-right-out"),
		ydUpperA: props.globals.getNode("/controls/fctl/switches/yd-upper-a"),
		ydUpperB: props.globals.getNode("/controls/fctl/switches/yd-upper-b"),
		ydLowerA: props.globals.getNode("/controls/fctl/switches/yd-lower-a"),
		ydLowerB: props.globals.getNode("/controls/fctl/switches/yd-lower-b"),
	},
	init: func() {
		me.resetFailures();
