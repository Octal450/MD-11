...
var Instrumentation = {
	...
	Pfd: {
		...
		altPreSelItaf: props.globals.initNode("/instrumentation/pfd/alt-pre-sel-itaf", 0, "DOUBLE"),
		...
		hdgPreSelItaf: props.globals.initNode("/instrumentation/pfd/heading-pre-sel-itaf", 0, "DOUBLE"),
		...
		iasPreSelItaf: props.globals.initNode("/instrumentation/pfd/ias-pre-sel-itaf", 0, "DOUBLE"),
